...
_Funders can easily create new escrows, define milestones, set amounts, and configure custom verifiers (e.g., contract deployment, TVL, transaction count)._
...
_Builders can view their assigned projects, track progress, and submit claims for completed milestones._
...
_A detailed view of specific escrows to track milestone states, trigger verifications, or manage disputes during the optimistic challenge window._
...
_Note: Copy the contract addresses printed in the console (Factory, MockUSDC, etc.)._
...
Open **[https://milestone-stream.vercel.app/](https://milestone-stream.vercel.app/)** in your browser. Connect your wallet using the RainbowKit button (configure MetaMask/Coinbase wallet for Anvil local network).
